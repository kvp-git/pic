...
3 lights railway crossing gate controller with train detect and manual push button inputs
...
| .vscode\pic12f508_crossing.mplab.json | The MPLAB project file, should not be deleted                                                                                       |
